...
public:
    ...
    {
        // Add CSV header
        file << "Simulation Time, Elongation, Force along Cable\n";
...
private:
    ...
    void calculateDampingAndForce()
    {
        ...
        double Project_G = force_x * unit_vector.x + 
                            force_y * unit_vector.y + 
                            force_z * unit_vector.z;

        double force_along_cable = force_x + force_y + force_z;
